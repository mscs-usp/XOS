...
int main (int argc, char* argv[])
{
    ...
    jd_valid.set_attribute (attribs::job_description_executable,  "/home/kortas/XTREEMOS/TESTS/SAGA/EX/job");
    jd_valid.set_attribute (attribs::job_description_executable,  "/home/kortas/XTREEMOS/TESTS/SAGA/JOB/ZEPHYR/zephyr.run");
    jd_valid.set_attribute (attribs::job_description_executable,  "/logiciels/mpiib/bin/mpirun ");
    jd_valid.set_attribute (attribs::job_description_arguments,  "-v -machinefile ZEPHYR/machine.list -np 1 ZEPHYR/zephyr < ZEPHYR/INPUT  > OUTPUT.saga");
